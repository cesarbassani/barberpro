/*
  # Add Order Status and Items Table
...
-- Add status to transactions table if it doesn't exist
DO $$ 
BEGIN
...
DROP POLICY IF EXISTS "Barbers and admins can manage order items" ON order_items;
